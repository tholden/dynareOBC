...
disp( 'Would you like to see results on determinacy of the Smets Wouters (2003) model and a variant with a response to the price level? (These are very slow, and require at least 32GB of RAM.)' );

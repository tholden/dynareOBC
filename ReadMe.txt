 ...
 * Settings for controlling estimation or smoothing 
    * Estimation 
          ...
          * MaximisationFunctions=STRING (default: CMAESWrapper,FMinConWrapper) 
                ...
                * CMAESResumeWrapper an evolutionary global search algorithm, resuming an 
                  interrupted CMAES run, 
                * ACDWrapper an adaptive coordinate descent algorithm, 
                * ACDResumeWrapper an adaptive coordinate descent algorithm, resuming an 
                  interrupted ACD run, 
                * PACDWrapper an alternative adaptive coordinate descent algorithm, 
                * PACDResumeWrapper an alternative adaptive coordinate descent algorithm, resuming 
                  an interrupted ACD run, 
 ...
 * from the nonlinear moving average toolkit, that is copyright Lan and Alexander Meyer-Gohde, 
   2014, 

...
%       Monte Carlo or default cubature. Setting this to zero disables adaptive cubature. 
%     * NoCubature 
...
%           issues e.g. with the positive definiteness of the state covariance matrix. The cubature 
%           method exactly integrates a polynomial of degree INTEGER. Thus, in a model without 
%           bounds, there is no need to have INTEGER larger than four times the order of 

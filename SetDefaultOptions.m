function dynareOBC_ = SetDefaultOptions( dynareOBC_ )
    ...
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'OrderFiveQuadrature', false );
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'PseudoOrderFiveQuadrature', false );  
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'RemoveNegativeQuadratureWeights', false );

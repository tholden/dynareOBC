function dynareOBC_ = SetDefaultOptions( dynareOBC_ )
    ...
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'CubatureAccuracy', 6 );    
    ...
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'Estimation', false );
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'EstimationDataFile', [ dynareOBC_.BaseFileName '.xlsx' ] );
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'EstimationFixedPointMaxIterations', 1000 );
    ...
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'Global', false );
    ...
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'NoCubature', false );
    ...
    dynareOBC_ = SetDefaultOption( dynareOBC_, 'NoStatisticalCubature', false );

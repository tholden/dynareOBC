function DisplayHelp
    ...
    disp( '      If accuracy=0, dynareOBC assumes that agents are "surprised" by the existence of the bound.' );
    disp( '      At order=1, this is equivalent to a perfect foresight solution to the model.' );
    disp( '      If accuracy=1, dynareOBC assumes agents realise that shocks may arrive in the near future which' );
    disp( '      push them towards the bound. However, they do not take into account the risk of hitting the' );

function dynareOBC = SetDefaultOptions( dynareOBC )
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'CubatureClusteringEffort', 0 );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'LPSolver', 'gurobi,cplex,xpress,mosek,scip,linprog,glpk,lpsolve,cdd,qsopt,*' );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'OtherMODFile', '' );
    dynareOBC = SetDefaultOption( dynareOBC, 'OtherMODFileSwitchToProbability', realmin );
    dynareOBC = SetDefaultOption( dynareOBC, 'OtherMODFileSwitchFromProbability', realmin );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'QuasiMonteCarloLevel', 15 );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'SkipAllSimulation', false );

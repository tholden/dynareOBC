function dynareOBC = SetDefaultOptions( dynareOBC )
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'LPSolver', 'xpress,gurobi,cplex,mosek,clp,scip,linprog,glpk,lpsolve,cdd,qsopt,*' );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'MinimisationFunctions', 'CMAESWrapper,FMinConWrapper' );   
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'PredictSparseCubatureDegree', 0 );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'UpdateSparseCubatureDegree', 0 );

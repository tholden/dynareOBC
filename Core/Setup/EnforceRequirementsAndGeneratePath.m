    ...
    if Update
        ...
        try
            if strcmp( Architecture, 'PCWIN' )
                ...
                DLLInstalled = CheckMSVCRequirement( '14.0', 26429, 'x86', 'https://aka.ms/vs/15/release/VC_redist.x86.exe', dynareOBCPath, '2017/vcredist_x86_25017.exe' ) || DLLInstalled;
            ...
            elseif strcmp( Architecture, 'PCWIN64' )
                DLLInstalled = CheckMSVCRequirement( '14.0', 26429, 'x64', 'https://aka.ms/vs/15/release/VC_redist.x64.exe', dynareOBCPath, '2017/vcredist_x64_25017.exe' ) || DLLInstalled;

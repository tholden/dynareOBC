    ...
    if Update
        ...
        try
            if strcmp( Architecture, 'PCWIN' )
                ...
                DLLInstalled = CheckRequirement( 'B5FC62F5-A367-37A5-9FD2-A6E137C0096F', 234904942, 'http://download.microsoft.com/download/6/D/F/6DF3FF94-F7F9-4F0B-838C-A328D1A7D0EE/vc_redist.x86.exe', dynareOBCPath, '2015/vcredist_x86.exe' ) || DLLInstalled;
            ...
            elseif strcmp( Architecture, 'PCWIN64' )
                ...
                DLLInstalled = CheckRequirement( 'C0B2C673-ECAA-372D-94E5-E89440D087AD', 234905234, 'http://download.microsoft.com/download/6/D/F/6DF3FF94-F7F9-4F0B-838C-A328D1A7D0EE/vc_redist.x64.exe', dynareOBCPath, '2015/vcredist_x64_u3.exe' ) || DLLInstalled;

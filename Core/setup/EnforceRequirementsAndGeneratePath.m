    ...
    if Update
        ...
        try
            ...
            elseif strcmp( Architecture, 'PCWIN64' )
                ...
                DLLInstalled = CheckRequirement( 'C0B2C673-ECAA-372D-94E5-E89440D087AD', 234905234, 'https://download.microsoft.com/download/4/2/F/42FF78CE-8DE0-4C88-AD7A-5F8DFFB49F74/vc_redist.x64.exe', dynareOBCPath, '2015/vcredist_x64_u3.exe' ) || DLLInstalled;
        ...
        if exist( [ dynareOBCPath '/FastStart.mat' ], 'file' )
            ...
            IgnoreList = { 'dynareOBC_', 'UpdateWarningStrings', 'M_', 'options_', 'oo_', 'AltPTestUseMex', 'ptestUseMex', 'spkronUseMex', 'MatlabPoolSize' };

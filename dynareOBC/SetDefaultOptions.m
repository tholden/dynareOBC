function dynareOBC = SetDefaultOptions( dynareOBC )
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'KappaPriorParameterB', 2-eps );
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'MLVSimulationAccuracy', 10 );  
    ...
    dynareOBC = SetDefaultOption( dynareOBC, 'TimeToEscapeBounds', 64 );
